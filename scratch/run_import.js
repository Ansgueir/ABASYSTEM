    ...
    if (!stu) {
      await prisma.student.create({
        data: {
          ...
          fieldworkType: String(s.fieldworkType || '').toUpperCase().includes('CONCENTRATED') ? 'CONCENTRATED' : 'REGULAR',
          ...
          level: String(s.level || '').toUpperCase().includes('MASTER') ? 'BCBA' : 'BCaBA',
          school: s.school || 'N/A',
